...
class PostNet(nn.Module):
    def __init__(self, n_convolutions: int, n_mel_channels: int, embedding_dim: int, kernel_size: int, dropout_rate: float = 0.5) -> None:
        super().__init__()
...
class PreNet(nn.Module):
    def __init__(self, in_dim: int, sizes: list, dropout_rate: float = 0.5) -> None:
        super().__init__()
